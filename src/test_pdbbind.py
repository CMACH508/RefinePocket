...
def get_pdbbind(DATA_ROOT):
    ...
    # remove: more than 50% sequence identity
    DATA_ROOT_ = os.path.abspath('/cmach-data/liuyongchang/program/_Drug_/dataset/')
    remove_list = open(join(DATA_ROOT_, 'PDBbind_v2020_refined/remove_list.txt')).readlines()
    remove_list = [name.strip() for name in remove_list]

    total_list = black_list + repeat_list + remove_list
...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_set', type=str, default='pdbbind')
    ...
    ckpt_path = '/home/liuyongchang/protein/unet_refine_dabh/model_saves/seg0-0.94758-133.pth.tar'
